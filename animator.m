...
theta_2 = [temp_2a flip(temp_2a) temp_2b avg_rot_2*([onez onez onez onez])];
theta_4 = [min_rot_4*([onez onez onez]) temp_4 flip(temp_4) min_rot_4*([onez onez])];
theta_11= [max_rot_11*([onez onez onez onez onez]) temp_11 flip(temp_11)];
...
% theta_2 = [avg_rot_2*([onez onez])];
% theta_4 = [max_rot_4*([onez onez])];
% theta_11= [temp_11 flip(temp_11)];
...
animate = true;
%% Set up zero vectors just to speed up simulation
if true
    Ox = zeros(length(theta_2));
    Oy = zeros(length(theta_2));
    Ax = zeros(length(theta_2));
    Ay = zeros(length(theta_2));
    Bx = zeros(length(theta_2));
    By = zeros(length(theta_2));
    Cx = zeros(length(theta_2));
    Cy = zeros(length(theta_2));
    Dx = zeros(length(theta_2));
    Dy = zeros(length(theta_2));
    Ex = zeros(length(theta_2));
    Ey = zeros(length(theta_2));
    Fx = zeros(length(theta_2));
    Fy = zeros(length(theta_2));
    Gy = zeros(length(theta_2));
    Gx = zeros(length(theta_2));
    Hx = zeros(length(theta_2));
    Hy = zeros(length(theta_2));
    Ix = zeros(length(theta_2));
    Iy = zeros(length(theta_2));
    Jx = zeros(length(theta_2));
    Jy = zeros(length(theta_2));
    Kx = zeros(length(theta_2));
    Ky = zeros(length(theta_2));
    Lx = zeros(length(theta_2));
    Ly = zeros(length(theta_2));
    Mx = zeros(length(theta_2));
    My = zeros(length(theta_2));
    Nx = zeros(length(theta_2));
    Ny = zeros(length(theta_2));
    Px = zeros(length(theta_2));
    Py = zeros(length(theta_2));
    Qx = zeros(length(theta_2));
    Qy = zeros(length(theta_2));
    Rx = zeros(length(theta_2));
    Ry = zeros(length(theta_2));
    Sx = zeros(length(theta_2));
    Sy = zeros(length(theta_2));
    Tx = zeros(length(theta_2));
    Ty = zeros(length(theta_2));
    Ux = zeros(length(theta_2));
    Uy = zeros(length(theta_2));
    Vx = zeros(length(theta_2));
    Vy = zeros(length(theta_2));
    Wx = zeros(length(theta_2));
    Wy = zeros(length(theta_2));
end
...
%     y_avg(i) = y_avg(i) + w11*avg_011x(i);
%     y_avg(i) = y_avg(i) + w12*avg_012x(i);
%     y_avg(i) = y_avg(i) + w13*avg_013x(i);
%     y_avg(i) = y_avg(i) + w14*avg_014x(i);
